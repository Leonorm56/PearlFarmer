...
import ATFAutoBoosterDetailsTab from "./ATFAutoBoosterDetailsTab";
...
export default function ATFAutoAccountBooster({ account }) {
  return (
    <Dialog.Portal>
      <Dialog.Overlay
        className={cn(
          ...
          >
            ...
            <div className="grow overflow-auto p-4">
              ...
              <Tabs.Content value="details">
                <ATFAutoBoosterDetailsTab account={account} />
              </Tabs.Content>
            </div>
          </Tabs.Root>
        </Dialog.Content>
